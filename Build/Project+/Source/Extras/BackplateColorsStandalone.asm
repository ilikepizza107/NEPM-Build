##############################################################################################
[CM: _BackplateColors] Backplate Color Code (Standalone Ver. 1.0.0) [QuickLava]
#
...
#########################################################################################
#CM: _BackplateColors] Reset Cached SelChar Team Battle Status on Init v2.0.1 [QuickLava]
#########################################################################################
HOOK @ $806945E8                # Address = $(ba + 0x006945E8)
{
...
##########################################################################
#CM: _BackplateColors] Cache SelChar Team Battle Status v2.0.1 [QuickLava]
##########################################################################
...
###############################################################################
#CM: _BackplateColors] Cache In-game Mode Team Battle Status v2.0.1 [QuickLava]
###############################################################################
...
##################################################################################################
#CM: _BackplateColors] Only 2P Stadium Boss Battles Are Considered Team Battles v2.0.1 [QuickLava]
##################################################################################################
...
#######################################################################################
#CM: _BackplateColors] Shield Color + Death Plume Override v2.0.1 [QuickLava]
...
HOOK @ $80855AB0                # Address = $(ba + 0x00855AB0)
{
	lis r11, BACKPLATE_COLOR_TEAM_BATTLE_STORE_LOC_HI
...
###############################################################################################################
#CM: _BackplateColors] Incr and Decr Slot Color with L/R, Reset with Z on Player Kind Button v2.0.1 [QuickLava]
###############################################################################################################
...
###############################################################################
#CM: _BackplateColors] Hand Color Fix v2.0.1 [QuickLava]
...
#####################################################################################################
#CM: _BackplateColors] Updating Player Kind (Player->CPU->None) Updates Hand Color v2.0.1 [QuickLava]
#####################################################################################################
HOOK @ $8068B5D4                # Address = $(ba + 0x0068B5D4)
{
...
########################################################################################################
#CM: _BackplateColors] Disable Franchise Icon Color 10-Frame Offset in Results Screen v2.0.1 [QuickLava]
########################################################################################################
* C60EBB98 800EBBB8             # Create Branch @ $(ba + 0x000EBB98): b 0x800EBBB8
* C60EBDE4 800EBE00             # Create Branch @ $(ba + 0x000EBDE4): b 0x800EBE00

#############################################################################################
#CM: _BackplateColors] CSS, In-game, and Results HUD Color Changer v2.0.1 [QuickLava]
# 
...
#############################################################################################
HOOK @ $80197FAC                # Address = $(ba + 0x00197FAC)
{
...
###########################################################################################
#CM: _BackplateColors] MenSelChr Element Override v2.0.1 [QuickLava]
# 
...
###########################################################################################
HOOK @ $8018DA3C                # Address = $(ba + 0x0018DA3C)
{
...
#####################################################################################
#CM: _BackplateColors] Results Screen Player Names are Transparent v2.0.1 [QuickLava]
#####################################################################################
...
##########################################################################
#CM: _BackplateColors] CSS Player Names are Transparent v2.0.1 [QuickLava]
##########################################################################
...
#########################################################################
#CM: _BackplateColors] MenSelChr Random Color Override v2.0.1 [QuickLava]
#########################################################################
HOOK @ $80697554                # Address = $(ba + 0x00697554)
{
	lis r11, BACKPLATE_COLOR_TEAM_BATTLE_STORE_LOC_HI
	lbz r12, BACKPLATE_COLOR_TEAM_BATTLE_STORE_LOC_LO(r11)
